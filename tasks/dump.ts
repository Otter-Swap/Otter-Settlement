...
import { Api, CallError, Environment, GetQuoteErrorType } from "../src/api";
...
export const APP_DATA = keccak("Otter dump script");
 ...
 * tokens into toToken with Otter. It returns structured information on all

...
const setupSolversTask: () => void = () => {
  task("solvers", "Reads and changes the list of allowed solvers in Otter.")
  ...
  subtask(
    "solvers-add",
    "Adds a solver to the list of allowed solvers in Otter.",
  )
  ...
  subtask(
    "solvers-remove",
    "Removes a solver from the list of allowed solvers in Otter.",
  )
  ...
  subtask(
    "solvers-check",
    "Checks that an address is registered as a solver of Otter.",
  )
  ...
  subtask(
    "solvers-list",
    "List all currently registered solvers of Otter.",

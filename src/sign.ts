 ...
 */
export const PRE_SIGNED = ethers.utils.id("OtterSigning.Scheme.PreSign");
...
/**
 * Encodes the necessary data required for the Otter contracts to
...
/**
 * Decodes a Otter EIP-1271-type signature into the actual EIP-1271 signature

...
describe("OtterSafeERC20.sol", () => {
  ...
  beforeEach(async () => {
    const OtterSafeERC20TestInterface = await ethers.getContractFactory(
      "OtterSafeERC20TestInterface",
    );
    executor = await OtterSafeERC20TestInterface.deploy();

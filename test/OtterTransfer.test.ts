...
describe("OtterTransfer", () => {
  ...
  beforeEach(async () => {
    const OtterTransfer = await ethers.getContractFactory(
      "OtterTransferTestInterface",
    );
    transfer = await OtterTransfer.deploy();
  ...
  describe("transferFromAccount", () => {
    ...
    it("reverts when mistakenly trying to transfer Ether", async () => {
      for (const balance of [
        ...
        ).to.be.revertedWith("Otter: cannot transfer native ETH");
      }
    });

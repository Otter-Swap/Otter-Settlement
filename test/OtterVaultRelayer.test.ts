...
describe("OtterVaultRelayer", () => {
  ...
  beforeEach(async () => {
    ...
    const OtterVaultRelayer = await ethers.getContractFactory(
      "OtterVaultRelayer",
      creator,
    );
    vaultRelayer = await OtterVaultRelayer.deploy(vault.address);
  });

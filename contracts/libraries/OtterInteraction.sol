...
/// @title Otter OtterInteraction Library
/// @author Otter Developers
library OtterInteraction {
    /// @dev OtterInteraction data for performing arbitrary contract interactions.
    /// Submitted to [`OtterSettlement.settle`] for code execution.
    struct Data {
        address target;
        uint256 value;
        bytes callData;
    ...
    ///
    /// @param interaction OtterInteraction data.

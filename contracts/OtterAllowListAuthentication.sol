...
/// @title Otter Access Control Contract
/// @author Otter Developers
contract OtterAllowListAuthentication is
    OtterAuthentication,
    Initializable,
    StorageAccessible
{
    ...
    modifier onlyManager() {
        require(manager == msg.sender, "Otter: caller not manager");
        _;
    }
    ...
    /// @inheritdoc OtterAuthentication

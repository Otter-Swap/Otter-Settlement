...
/// @title Otter Vault Relayer Contract
/// @author Otter Developers
contract OtterVaultRelayer {
    ...
    modifier onlyCreator() {
        require(msg.sender == creator, "Otter: not creator");
        _;
    }
    ...
    function transferFromAccounts(OtterTransfer.Data[] calldata transfers)
        external
        onlyCreator
    {
    ...
    function batchSwapWithFee(
        ...
        uint256 deadline,
        OtterTransfer.Data calldata feeTransfer
